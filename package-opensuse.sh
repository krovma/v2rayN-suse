...
case "${ID:-}" in
  ...
  *)
    ...
    echo "This script only supports: openSUSE Tumbleweed / openSUSE Leap."
    exit 1
    ;;
esac
...
# Suppress rpmlint/deprecated-group-check noise for prebuilt binary payload
...
Requires:       bash >= 5.1
Requires:       libfreetype6 >= 2.10

%description
v2rayN Linux for openSUSE
Support vless / vmess / Trojan / http / socks / Anytls / Hysteria2 / Shadowsocks / tuic / WireGuard
Support openSUSE Tumbleweed / openSUSE Leap
